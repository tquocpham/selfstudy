...
int main()
{
    ...
    ht_set(hashtable, "rtyu", (void *)(intptr_t)10);
    ht_set(hashtable, "fghj", (void *)(intptr_t)11);
    ht_set(hashtable, "cvbn", (void *)(intptr_t)12);
    ht_set(hashtable, "xcvb", (void *)(intptr_t)13);
    ht_set(hashtable, "vbnm", (void *)(intptr_t)14);
    ht_set(hashtable, "dsfg", (void *)(intptr_t)15);
    ht_set(hashtable, "hgfd", (void *)(intptr_t)16);
    ht_set(hashtable, "jhgf", (void *)(intptr_t)17);
    ht_set(hashtable, "jhif", (void *)(intptr_t)18);
    printf("%ld\n", hashtable->capacity);
    printf("%ld\n", hashtable->length);
    printf("%ld\n", hashtable->length);
